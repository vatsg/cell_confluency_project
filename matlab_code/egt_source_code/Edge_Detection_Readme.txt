...
EGT_Segmentation.exe
MCR_R2013a_win64_installer.exe


****************************************************************
Instructions
-Download MCR
-Install MCR (using Matlab's Installer)
-Run EGT_Segmentation.exe


To download MCR from Matlab MCR R2013a (8.1):
http://www.mathworks.com/products/compiler/mcr/



To Run this from Matlab
-navigate Matlab's current folder menu to 'Edge_Detection_GUI' folder
-run 'Edge_Detection_GUI_v1.m'

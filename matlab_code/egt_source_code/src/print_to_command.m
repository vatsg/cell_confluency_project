...
function print_to_command(value, tgt_dir)
...
if use_log_file_flag
    log_file_path = [tgt_dir filesep getenv('username') '_log' sprintf('_%04d_%02d_%02d',date_vector(1),date_vector(2),date_vector(3)) '.log'];
